...
<a href="https://aka.ms/swadocs" target="_blank">https://aka.ms/swadocs</a>
</div>
</div>
...
<div class="box info">
<div>
If you want to learn more about the different authorization levels for Functions and how to secure your API, check out the docs <a href="https://docs.microsoft.com/azure/azure-functions/security-concepts" target="_blank">here</a>.
</div>
</div>
...
<div class="box tip">
<div>
If you are building a React app, go <a href="https://docs.microsoft.com/learn/modules/publish-static-web-app-authentication/?WT.mc_id=javascript-17844-cxa" target="_blank">check the Microsoft Learn module</a> that will show you how to do it.
</div>
</div>
...
Start by opening the <a href="https://portal.azure.com/#create/Microsoft.DocumentDB" target="_blank">Create Azure Cosmos DB form</a> in the Azure Portal. For our application, we are going to use the `MongoDB` API so select `Azure Cosmos DB API for MongoDB`
...
<a href="https://www.youtube.com/watch?v=R9qhGra9FHs&list=PLlrxD0HtieHgMPeBaDQFx9yNuFxx6S1VG&t=112s" target="_blank">
  <img src="images/swa-tips-video-environment.png">
</a>
...
<div class="box assignment">
<div>
Create an <a href="https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview" target="_blank">Application Insights</a> resource in your Resource Group and connect it to your Static Web App.
</div>
</div>
